#' Myocardial Infarction primary inpatient
#'
...
#' @export
mi_primary_inpatient <- function(output_folder,anchor_date_table=NULL,before=NULL,after=NULL)
{
    ...
    result_all <- setDT(result_all)[,.(mi_primary_inpatient_status = TRUE,
                                       mi_primary_inpatient_entry_date = hospitalization_entry_date[1]),
                                     .(person_id)]
    .write_to_bucket(result_all,output_folder,"mi_primary_inpatient")
}
