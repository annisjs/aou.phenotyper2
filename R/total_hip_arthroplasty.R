...
#'
#' @export
total_hip_arthoplasty <- function(output_folder,anchor_date_table=NULL,before=NULL,after=NULL)
{
    ...
    result_all <- result_all[,.(total_hip_arthoplasty_entry_date = entry_date[1],
                              ...
                              .(person_id)]
    .write_to_bucket(result_all,output_folder,"total_hip_arthoplasty")
}