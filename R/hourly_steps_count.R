...
#' @export
hourly_steps_count <- function(output_folder,anchor_date_table=NULL,before=NULL,after=NULL)
{
  result <- aou.reader::hourly_steps_query(anchor_date_table,before,after)
