...
#' @return output_folder/copd_inpatient_all.csv
...
#'
#' @export
copd_inpatient_all <- function(output_folder,anchor_date_table=NULL,before=NULL,after=NULL)
{
  ...
  .write_to_bucket(result_all,output_folder,"copd_inpatient_all")
}
