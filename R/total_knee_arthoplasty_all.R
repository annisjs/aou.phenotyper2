...
#'
#' @export
total_knee_arthoplasty_all <- function(output_folder,anchor_date_table=NULL,before=NULL,after=NULL)
{
  ...
  .write_to_bucket(result_all,output_folder,"total_knee_arthoplasty_all")
}