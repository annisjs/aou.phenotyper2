...
#'
#' @export
coronary_artery_bypass_graft <- function(output_folder,anchor_date_table=NULL,before=NULL,after=NULL)
{
    ...
    result_all <- result_all[,.(coronary_artery_bypass_graft_entry_date = entry_date[1],
                              ...
                              .(person_id)]
    .write_to_bucket(result_all,output_folder,"coronary_artery_bypass_graft")
}