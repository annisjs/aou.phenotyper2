...
#' @export
dcm_outcomes_ventricular_arrhythmia <- function(output_folder,anchor_date_table=NULL,before=NULL,after=NULL)
{    
    icd9_codes <- c('427.1','427.41','427.4','427.5','427.5','798','V12.53','427.42')

    icd10_codes <- c('I47.2','I47.0','I49.02','I49.01','I46.2','I46.8','I46.9','Z86.74','I49.0')
    ...
    final_write <- final[,.(dcm_outcomes_ventricular_arrhythmia_entry_date = min(condition_start_date),
                                        dcm_outcomes_ventricular_arrhythmia_status = length(condition_start_date) >= 1),
                                    .(person_id)]
    .write_to_bucket(final_write,output_folder,"dcm_outcomes_ventricular_arrhythmia")
}