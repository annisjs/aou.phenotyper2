...
#' @export
heart_failure_inpatient_all <- function(output_folder,anchor_date_table=NULL,before=NULL,after=NULL)
{
  ...
  .write_to_bucket(result_all,output_folder,"heart_failure_inpatient_all")
}
