...
{
    result_all <- aou.reader::lab_query(c("Alanine aminotransferase",
                       "Alanine aminotransferase [Enzymatic activity/volume] in Serum or Plasma",
                       "Alanine aminotransferase | Serum or Plasma | Chemistry - non-challenge"),
                        anchor_date_table,before,after)
    colnames(result_all) <- c("person_id","all_alt_entry_date","all_alt_value")
    .write_to_bucket(result_all,output_folder,"all_alt")
}