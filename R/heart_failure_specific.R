#' Heart failure, specific definition
#'
...
#' @details Removes codes that could be associated with cardiomyopathy. 
#' At least 1 inpatient or 2 outpatient ICD codes:
#'
#' ICD9: "428","428.%",
#'
#' ICD10: "I50","I50.%"
#' @export
heart_failure_specific <- function(output_folder,anchor_date_table=NULL,before=NULL,after=NULL)
{
    # Pull inpatient and outpatient codes
    codes <- c("428","428.%","I50","I50.%")
    ...
    hf_counts[,heart_failure_specific_status := hf_inpt_status | hf_outpt_status]
