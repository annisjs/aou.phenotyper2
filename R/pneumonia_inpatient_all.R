...
#' @export
pneumonia_inpatient_all <- function(output_folder,anchor_date_table=NULL,before=NULL,after=NULL)
{
  ...
  result_all <- result_all[,.(pneumonia_inpatient_status = TRUE,
                              pneumonia_inpatient_entry_date = condition_start_date[1]),
                           .(person_id, condition_start_date)]
  .write_to_bucket(result_all,output_folder,"pneumonia_inpatient_all")
}
