...
#' @export
pneumonia_primary_inpatient <- function(output_folder,anchor_date_table=NULL,before=NULL,after=NULL)
{
  ...
  result_all <- result_all[,.(pneumonia_primary_inpatient_status = TRUE,
                            ...
                            .(person_id)]
  .write_to_bucket(result_all,output_folder,"pneumonia_primary_inpatient")
}
