...
{
    result_all <- aou.reader::lab_query(c("Urea nitrogen [Mass/volume] in Serum or Plasma"),
                        anchor_date_table,before,after)
    colnames(result_all) <- c("person_id","all_bun_entry_date","all_bun_value")
    .write_to_bucket(result_all,output_folder,"all_bun")
}