...
dcm <- function(output_folder,anchor_date_table=NULL,before=NULL,after=NULL)
{
  ...
  dcm_snomeds_list <- c('1264404009','35719004','36471000','60514000','58911001',
                                                       '880038008','11104006','30496006','50270004','2816000',
                                                       '58629009','880014009','46696008','39693003','86194008',
                                                       '54830008','44630002','1153452008','40532006','74249003',
                                                       '111285003','1149109001','8209004','86995005','413995009',
                                                       '28869005','79152002','84733009','91604001','21430002','6022005',
                                                       '871639003','702424003','64749001','719451006','766883006','472327008',
  ...
  dcm <- rbindlist(list(dcm_icd10s,dcm_snomeds))
  dcm$dcm_status <- TRUE

  #DCM assw / NICM
  dcm_assw_icd10_list <- c("I42.6","I42.7","O90.3",'A36.81','B33.24')
  dcm_assw_icd9_list <- c("425.5","674.50","674.51","674.52","674.53","674.54")
  dcm_assw_snomeds_list <- c('1264404009',
                            '35719004','36471000','60514000','58911001','880038008','11104006','1137377003',
                            '204981000119101','30496006','315608004','50270004','195031006','2816000','50275009',
                            '58629009','880014009','46696008','39693003','86194008','54830008','44630002',
                            '1153452008','40532006','74249003','111285003','1149109001','8209004','86995005',
                            '413995009','28869005','79152002','84733009','91604001','21430002','6022005',
                            '46939000','871639003','233875006','789037005','399020009','702424003','64749001',
                            '719451006','766883006','472327008','111000119104','413994008','699668009',
                            '12563008','16253001','195021004','52029003','53043001','471890009',
                            '20529002','165468981000119000','723993005','719835006','471870000',
                            '774148007','62377009','240077004','426300009','103331000119103',
                            '16228931000119100','72972005','880042006','1234750000','195036001',
                            '639641000000102','193234005','199277001','186812009','74368002','389995008','83521008',
                            '2180001','34342000','90202001','2024009','29201009','1954004','702343002','703275009',
                            '233874005','765651000000100','195579007','442521000000100')
  ...
  dcm_assw <- rbindlist(list(dcm_assw_icd10s,dcm_assw_icd9s,dcm_assw_snomeds))
  ...
  mi <- rbindlist(list(mi_icd10s,mi_icd9s,mi_snomeds))
  mi$mi_status <- TRUE
  ...
  hcm <- rbindlist(list(hcm_icd9s,hcm_icd10s,hcm_snomeds))
  hcm$hcm_status <- TRUE
  ...
  rcm <- rbindlist(list(rcm_icd10s,rcm_snomeds))
  rcm$rcm_status <- TRUE
  ...
  lvsd <- rbindlist(list(lvsd_icd10s,lvsd_icd9s,lvsd_snomeds))
  ...
  final <- select(data,person_id,dcm_case,nicm_case,dcm_control,exclude)
