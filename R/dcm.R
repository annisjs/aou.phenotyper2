...
dcm <- function(output_folder,anchor_date_table=NULL,before=NULL,after=NULL)
{
  ...
  #DCM
  dcm_icd10_list <- c("I42.0")
  dcm_snomeds_list <- c("1264404009","35719004","36471000","60514000","58911001","880038008","11104006",
                                                       "30496006","50270004","2816000","58629009","880014009","46696008","39693003",
                                                       "86194008","54830008","44630002","1153452008","40532006","74249003","111285003",
                                                       "1149109001","8209004","86995005","413995009","28869005","79152002","84733009",
                                                       "91604001","21430002","6022005","871639003","399020009","702424003","64749001",
                                                       "719451006","766883006","472327008","413994008","12563008","16253001","195021004",
                                                       "52029003","53043001","471890009","20529002","165468981000119000","723993005",
                                                       "719835006","72972005","880042006","1234750000","74368002","389995008","83521008",
                                                       "2180001","34342000","90202001","2024009","29201009","1954004","233874005")
  ...
  #DCM assw / NICM
  dcm_assw_icd10_list <- c("A36.81","B33.24","I42.0","I42.6","I42.7","O90.3")
  dcm_assw_icd9_list <- c("425.5","674.50","674.51","674.52","674.53","674.54")
  dcm_assw_snomeds_list <- c("1264404009","35719004","36471000","60514000","58911001","880038008",
                                                            "11104006","1137377003","204981000119101","30496006","315608004",
                                                            "50270004","195031006","2816000","50275009","58629009","880014009",
                                                            "46696008","39693003","86194008","54830008","44630002","1153452008",
                                                            "40532006","74249003","111285003","1149109001","8209004","86995005",
                                                            "413995009","28869005","79152002","84733009","91604001","21430002",
                                                            "6022005","46939000","871639003","233875006","789037005","399020009",
                                                            "702424003","64749001","719451006","766883006","472327008","111000119104",
                                                            "413994008","699668009","12563008","16253001","195021004","52029003",
                                                            "53043001","471890009","20529002","165468981000119000","723993005",
                                                            "719835006","471870000","774148007","62377009","240077004","426300009",
                                                            "103331000119103","16228931000119100","72972005","880042006","1234750000",
                                                            "195036001","639641000000102","193234005","199277001","186812009",
                                                            "74368002","389995008","83521008","2180001","34342000","90202001","2024009",
                                                            "29201009","1954004","702343002","703275009","233874005","765651000000100",
                                                            "195579007","442521000000100")
  ...
  #HCM
  hcm_icd9_list <- c("425.11","425.18")
  hcm_icd10_list <- c("I42.1","I42.2")
  hcm_snomeds_list <- c("1204192000","704241002","871638006","1230303001","890119003",
                                                       "472326004","890122001","472325000","890121008","871649000","890120009"
                                                       ,"472316006","717812000","763280005","771509001","718713000","472318007",
                                                       "771513008","771478008","233871002","83978005","472324001","233873004",
                                                       "1204194004","471885006","195020003","45227007","700065003","63183009",
                                                       "719272007","389998005","445336009","53322007","93558006","41964001",
                                                       "389999002","15471000","195574002","443751000000108")
  ...
  #RCM
  rcm_icd10_list <- c("I42.5")
  rcm_snomeds_list <- c('419231000000102','195575001','195015003','715626008','39041004',
                                                        '24584003','15544002','56941009','76931005','64615000','33006007',
                                                        '79754008','84725008','415509000','398754006','233877003',
                                                        '64041007','33258008','42099002',
                                                        '90828009','715655000','30884007','233878008','415295002',
  ...
  #combine 
  data <- merge(subjects,dcm[, c("person_id", "dcm_status", "dcm_entry_date")],by="person_id", all.x = T, allow.cartesian = T)
  data <- merge(data,dcm_assw[, c("person_id", "dcm_assw_status", "dcm_assw_entry_date")],by="person_id", all.x = T, allow.cartesian = T)
  ...
  data <- merge(data,lvsd[, c("person_id", "lvsd_status","lvsd_entry_date")],by="person_id", all.x = T, allow.cartesian = T)
