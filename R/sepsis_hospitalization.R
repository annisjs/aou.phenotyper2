...
#' 
#' @export
sepsis_hospitalization <- function(output_folder,anchor_date_table=NULL,before=NULL,after=NULL)
{
    hosp <- aou.reader::hospitalization_query(c("995.91", "995.92", "785.52"))
    icd10 <- aou.reader::hospitalization_query(c("A02.1","A20.7","A22.7","A26.7","A32.7","A39.1","A39.2","A39.3","A39.4","A39.89","A39.9","A40.0","A40.1","A40.3","A40.8","A40.9","A41.01","A41.02","A41.1","A41.2","A41.3","A41.4","A41.50","A41.51","A41.52","A41.53","A41.59","A41.81","A41.89","A41.9","A42.7","A54.86","B00.7","B37.7","R57.1","R57.8","R65.10","R65.11","R65.20","R65.21","R78.81"))
    icd9_1 <- aou.reader::hospitalization_query(c("001","001.%","002","002.%","003","003.%","004","004.%","005","005.%","008","008.%","009","009.%","010","010.%","011","011.%","012","012.%","013","013.%","014","014.%","015","015.%","016","016.%","017","017.%","018","018.%","020","020.%","021","021.%","022","022.%","023","023.%","024","024.%","025","025.%","026","026.%","027","027.%","030","030.%","031","031.%","032","032.%","033","033.%","034","034.%","035","035.%","036","036.%","037","037.%","039","039.%","040","040.%","041","041.%","090","090.%","091","091.%","092","092.%","093","093.%","094","094.%","095","095.%","096","096.%","097","097.%","098","098.%","100","100.%","101","101.%","102","102.%","103","103.%","104","104.%","110","110.%","111","111.%","112","112.%","114","114.%","115","115.%","116","116.%","117","117.%","118","118.%","320","320.%","322","322.%","324","324.%","325","325.%","420","420.%","421","421.%","451","451.%","461","461.%","462","462.%","463","463.%","464","464.%","465","465.%","481","481.%","482","482.%","485","485.%","486","486.%","494","494.%","510","510.%","513","513.%","540","540.%","541","541.%","542","542.%","566","566.%","567","567.%","590","590.%","597","597.%","601","601.%","614","614.%","615","615.%","616","616.%","681","681.%","682","682.%","683","683.%","686","686.%","730","730.%","491.21","562.01","562.03","562.11","562.13","569.5","569.83","572.0","572.1","575.0","599.0","711.0","790.7","996.6","998.5","999.3"))
    icd9_2 <- aou.reader::hospitalization_query(c("785.5", "458", "458.%", "96.7", "348.3", "293", "293.%", "348.1", "287.4", "287.5", "286.9", "286.6", "570", "570.%", "573.4", "584", "584.%"))
    hosp <- hosp[,c("person_id","hospitalization_entry_date")]
    icd10 <- icd10[,c("person_id","hospitalization_entry_date")]
    icd9_1 <- icd9_1[,c("person_id","hospitalization_entry_date")]
    icd9_2 <- icd9_2[,c("person_id","hospitalization_entry_date")]
    icd9 <- merge(icd9_1,icd9_2,by=c("person_id","hospitalization_entry_date"))
    icd9[, hospitalization_entry_date := as.Date(hospitalization_entry_date)]
    icd10[, hospitalization_entry_date := as.Date(hospitalization_entry_date)]
    hosp[, hospitalization_entry_date := as.Date(hospitalization_entry_date)]
    result_all <- rbind(icd9,icd10,hosp)
    result_all <- result_all[order(hospitalization_entry_date)]
    result_all <- result_all[,.(sepsis_hospitalization_entry_date = hospitalization_entry_date[1],
                                sepsis_hospitalization_status = TRUE),
                            .(person_id)]
    .write_to_bucket(result_all,output_folder,"sepsis_hospitalization")
}