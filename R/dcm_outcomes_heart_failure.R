...
#' @export
dcm_outcomes_heart_failure <- function(output_folder,anchor_date_table=NULL,before=NULL,after=NULL)
{    
    icd9_codes <- c('33.6','37.51','V42.1','785.51','37.66','37.6','398.91','402.01','402.11',
    '402.91','404.01','404.03','404.11','404.13','404.91','404.93','428.0','428.1','428.20',
    ...
    'I50.812','I50.813','I50.814','I50.82','I50.83','I50.84','I50.89','I50.9','I97.11','I97.110',
    'I97.111','I97.13','I97.130','I97.131','O29.12','O29.121','O29.122','O29.123','O29.129','P29.0')
    ...
    '0458T','0459T','0460T','0461T','33982','33983','33990')
    ...
    final_write <- final[,.(dcm_outcomes_heart_failure_entry_date = min(condition_start_date),
                                        dcm_outcomes_heart_failure_status = length(condition_start_date) >= 1),
                                    .(person_id)]
    .write_to_bucket(final_write,output_folder,"dcm_outcomes_heart_failure")
}